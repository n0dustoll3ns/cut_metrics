...
class _DashboardViewState extends State<DashboardView> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<WeightViewModel>().authorizeAndFetchWeightData();
      context.read<NutritionViewModel>().authorizeAndFetchNutritionData();
      context.read<SleepViewModel>().authorizeAndFetchSleepData();
    });
  }
